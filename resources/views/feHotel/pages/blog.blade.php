                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="post-thumbnail">
                                    <figure class="gradient-overlay-hover link-icon">
                                        <a href="blog-post.html">
                                            <img src="{{asset('feHotel/images/blog/blog-post4.jpg')}}" class="img-fluid" alt="Image">
                                        </a>
                                    </figure>
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="post-details">
                                    ...
                                    <div class="post-meta">
                                        <span class="author">
                                            <a href="#"><img src="{{asset('feHotel/images/users/admin.jpg')}}" width="16" alt="Image">JANE Doe</a>
                                        </span>
                                        <span class="date">
                                            <a href="#">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="post-thumbnail">
                                    <figure class="gradient-overlay-hover link-icon">
                                        <a href="blog-post.html">
                                            <img src="{{asset('feHotel/images/blog/blog-post5.jpg')}}" class="img-fluid" alt="Image">
                                        </a>
                                    </figure>
                                </div>
                            </div>
                ...
                <div class="sidebar">
                    ...
                    <aside class="widget">
                        ...
                        <div class="tagcloud">
                            ...
                            <a href="#"><span class="tag">Travel</span></a>
                            <a href="#"><span class="tag">Wedding</span></a>
                            <a href="#"><span class="tag">Food</span></a>
