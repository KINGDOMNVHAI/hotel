...
<link rel="icon" href="{{asset('feHotel/images/favicon.png')}}">
...
<link rel="stylesheet" href="{{asset('feHotel/css/magnific-popup.css')}}">
<link rel="stylesheet" href="{{asset('feHotel/css/style.css')}}">
<link rel="stylesheet" href="{{asset('feHotel/css/responsive.css')}}">

<link href="{{asset('feHotel/fonts/font-awesome.min.css')}}" rel="stylesheet">
